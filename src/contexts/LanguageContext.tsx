...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    "landing.nav.about": "عن التطبيق",
    "landing.hero.badge": "نظام إدارة الديون والزبائن الأول",
    "landing.hero.title": "أدر مدفوعاتك بذكاء واحترافية",
    "landing.hero.subtitle": "ديوني هو الحل المتكامل لأصحاب المنشآت لإدارة السجلات المالية، مراقبة الديون، وتنبيه الزبائن بأسلوب عصري ومنظم يضمن لك حقوقك المالية.",
    "landing.hero.cta.download": "تحميل التطبيق",
    "landing.hero.cta.contact": "تواصل معنا",
    "landing.hero.badge.safe": "بيانات آمنة",
    "landing.hero.badge.safe.desc": "تشفير كامل لكافة سجلاتك المالية مع نسخ احتياطي دوري ومنظم.",
    "landing.features.title": "كل ما تحتاجه في مكان واحد",
    "landing.features.subtitle": "صممنا \"ديوني\" ليكون بسيطاً في الشكل، عميقاً في الإمكانيات، ليناسب كافة أحجام التجارة والمنشآت.",
    "landing.features.1.title": "تقارير مالية دقيقة",
    "landing.features.1.desc": "احصل على رؤية شاملة لديونك وسداداتك من خلال رسوم بيانية واضحة تفصيلية.",
    "landing.features.2.title": "تنبيهات ذكية",
    "landing.features.2.desc": "أرسل إشعارات وتنبيهات للزبائن بموعد السداد لزيادة سرعة التحصيل والالتزام.",
    "landing.features.3.title": "نسخ احتياطي إكسل",
    "landing.features.3.desc": "قم بتصدير كافة بياناتك لملفات Excel بلمسة واحدة لسهولة الأرشفة والقراءة والمحاسبة.",
    "landing.features.4.title": "خصوصية مطلقة",
    "landing.features.4.desc": "بيانات منشأتك وزبائنك محمية بأحدث معايير الأمان والتشفير العالمي المتطور.",
    "landing.features.5.title": "إدارة الحركات",
    "landing.features.5.desc": "تتبع كل ريال يدخل أو يخرج من خلال سجل حركات مفصل لكل زبون بالثانية واللحظة.",
    "landing.features.6.title": "مزامنة سحابية",
    "landing.features.6.desc": "بياناتك معك دائماً على كافة أجهزتك من خلال مزامنة سحابية فورية وآمنة وتلقائية.",
    "landing.footer.tagline": "ثورة في إدارة الديون للشركات الصغيرة والمتوسطة. بساطة، أمان، واحترافية مطلقة.",
  ...
  en: {
    ...
    "landing.hero.badge": "Top Debt & Customer Management System",
    "landing.hero.title": "Manage your payments with intelligence & professionalism",
    "landing.hero.subtitle": "Deyoni is the comprehensive solution for business owners to manage financial records, monitor debts, and alert customers in a modern and organized way that guarantees your financial rights.",
    "landing.hero.cta.download": "Download App",
    "landing.hero.cta.contact": "Contact Us",
    "landing.hero.badge.safe": "Secure Data",
    "landing.hero.badge.safe.desc": "Full encryption for all your financial records with regular and organized backup.",
    "landing.features.title": "Everything You Need in One Place",
    "landing.features.subtitle": "We designed \"Deyoni\" to be simple in form, deep in capabilities, to suit all sizes of businesses and facilities.",
    "landing.features.1.title": "Accurate Financial Reports",
    "landing.features.1.desc": "Get a comprehensive view of your debts and payments through clear, detailed graphs.",
    "landing.features.2.title": "Smart Notifications",
    "landing.features.2.desc": "Send notifications and alerts to customers on payment due dates to increase collection speed and commitment.",
    "landing.features.3.title": "Excel Backup",
    "landing.features.3.desc": "Export all your data to Excel files with one touch for easy archiving, reading, and accounting.",
    "landing.features.4.title": "Absolute Privacy",
    "landing.features.4.desc": "Your business and customer data are protected by the latest advanced global security and encryption standards.",
    "landing.features.5.title": "Transaction Management",
    "landing.features.5.desc": "Track every riyal coming in or out through a detailed transaction log for each customer per second and moment.",
    "landing.features.6.title": "Cloud Sync",
    "landing.features.6.desc": "Your data is always with you on all your devices through instant, secure, and automatic cloud synchronization.",
    "landing.footer.tagline": "Revolutionizing debt management for SMEs. Simplicity, security, and absolute professionalism.",
